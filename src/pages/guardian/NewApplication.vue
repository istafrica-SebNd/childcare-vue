...
import { FileText, Calendar, User, Shield, Building2 } from 'lucide-vue-next'
...
<template>
  <div class="min-h-screen bg-gray-50 p-8">
    ...
    <!-- Header Section -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ t('newApplication.title', 'New Application') }}</h1>
      <p class="text-gray-600">{{ t('newApplication.description', 'Create a new kindergarten application') }}</p>
    </div>
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  @input="handlePersonalNumberChange(($event.target as HTMLInputElement)?.value || '')"
                  type="text"
